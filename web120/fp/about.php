...
<main class="wrapper">
    ...
    <section>
        <header>
            <h2>Destination Who?</h2>
        </header>
        <div class="bios flex-container">
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back">
                        <h4>Kayako Saeki</h4>
                        <p>Spirit, Poltergeist</p>
                        <p>Likes to hang in dark corners</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back">
                        ...
                        <p>Fiend, Lover, and Zombie</p>
                        <p>Loves moonlit walks and brains</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back">
                        ...
                        <p>Skeleton and Undead Activist</p>
                        <p>Takes a mop to bars</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back">
                        <h4>Jack O'Landon</h4>
                        <p>SciFi Author and Mischievous Spirit</p>
                        <p>Enjoys leather/cigar bars</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flip-card">
                <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back">
                        <h4>Itt Addams</h4>
                        <p>Entrepreneur and Philanthropist</p>
                        <p>Loves to hike and swim</p>
                    </div>
                </div>
            </div>
