...
<main class="wrapper">
    <div>
        ...
        <h2>Lights, Camera, Weird...</h2>
        <P>Gallery of films and videos.</P>
        ...
        <div id="myModal" class="gallery-modal">
            ...
            <div class="gal-modal-content">
                ...
                <div class="mySlides">
                    ...
                    <img src="images/galleries_temp/img1.jpg">
                </div>

                <div class="mySlides">
                    <div class="numbertext">2 / 4</div>
                    <img src="images/galleries_temp/img2.jpg">
                </div>

                <div class="mySlides">
                    <div class="numbertext">3 / 4</div>
                    <img src="images/galleries_temp/img3.jpg">
                </div>

                <div class="mySlides">
                    <div class="numbertext">4 / 4</div>
                    <img src="images/galleries_temp/img4.jpg">
                </div>
    ...
    <div class="threads">
        ...
        <h2>Comment Section - Coming Eventually</h2>
