<?php
/**
 * contact_form.php is a postback application designed to provide a 
 * contact form for users to email our clients.  
 * 
 * contact_form.php provides a larger form with more elements to provide 
        ...
        <div>
            <label>
                ...
                <select name="How_Did_You_Hear_About_Us?" required="required" title="How You Heard is required" tabindex="30">
                    <option value="">How did you hear about Destination Weird?</option>
